module github.com/furyanrasta/blackfury/v3

go 1.18

require (
	cosmossdk.io/x/evidence v0.0.0-20230531104936-89b10094a2da
	cosmossdk.io/x/feegrant v0.0.0-20230531104936-89b10094a2da
	cosmossdk.io/x/upgrade v0.0.0-20230531104936-89b10094a2da
