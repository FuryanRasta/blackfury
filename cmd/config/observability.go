...
func EnableObservability() error {
	...
	// Please see https://github.com/blackfurystation/blackfury/v3/issues/84
	// return nil
	// }

	// pe, err := prometheus.NewExporter(prometheus.Options{
	// 	Namespace: "blackfuryd",
	// })
	// if err != nil {
	...
	// // TODO: Derive the Prometheus observability exporter from the Blackfury config.
	// addr := ":8877"
	// go func() {
