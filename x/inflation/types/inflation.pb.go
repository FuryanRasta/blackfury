...
// source: blackfury/inflation/v1/inflation.proto
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "blackfury.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "blackfury.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("blackfury/inflation/v1/inflation.proto", fileDescriptor_802efa57c3573b59)
}
