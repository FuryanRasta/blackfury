...
// source: blackfury/vrf/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateRandom)(nil), "blackfury.vrf.v1.MsgCreateRandom")
	proto.RegisterType((*MsgCreateRandomResponse)(nil), "blackfury.vrf.v1.MsgCreateRandomResponse")
}

func init() { proto.RegisterFile("blackfury/vrf/v1/tx.proto", fileDescriptor_6119d0590758c3b2) }
...
func (c *msgClient) CreateRandom(ctx context.Context, in *MsgCreateRandom, opts ...grpc.CallOption) (*MsgCreateRandomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.vrf.v1.Msg/CreateRandom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateRandom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.vrf.v1.Msg/CreateRandom",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "blackfury.vrf.v1.Msg",
	...
	Metadata: "blackfury/vrf/v1/tx.proto",
}
