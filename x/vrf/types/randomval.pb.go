...
// source: blackfury/vrf/v1/randomval.proto
...
func init() {
	proto.RegisterType((*Randomval)(nil), "blackfury.vrf.v1.Randomval")
}

func init() { proto.RegisterFile("blackfury/vrf/v1/randomval.proto", fileDescriptor_6f0232beec08fea7) }
