...
A user can query the Blackfury `x/vesting` module using the CLI, gRPC, or REST.

## CLI

Find below a list of `blackfuryd` commands added with the `x/vesting` module. You can obtain the full list by using the `blackfuryd -h` command.
...
```go
blackfuryd query vesting balances [address] [flags]
```
...
```go
blackfuryd tx vesting create-clawback-vesting-account [to_address] [flags]
```
...
```go
blackfuryd tx vesting clawback [address] [flags]
```
...
| ------ | -------------------------------------- | -------------------------------------- |
| `gRPC` | `blackfury.vesting.v1.Query/Balances`      | Gets locked, unvested and vested coins |
| `GET`  | `/blackfury/vesting/v1/balances/{address}` | Gets locked, unvested and vested coins |

### Transactions

| Verb   | Method                                                 | Description                      |
| ------ | ------------------------------------------------------ | -------------------------------- |
| `gRPC` | `blackfury.vesting.v1.Msg/CreateClawbackVestingAccount`    | Creates clawback vesting account |
| `gRPC` | `/blackfury.vesting.v1.Msg/Clawback`                       | Performs clawback                |
| `GET`  | `/blackfury/vesting/v1/tx/create_clawback_vesting_account` | Creates clawback vesting account |
| `GET`  | `/blackfury/vesting/v1/tx/clawback`                        | Performs clawback                |
