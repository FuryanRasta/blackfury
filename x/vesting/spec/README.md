...
This document specifies the internal `x/vesting` module of the Blackfury Hub.
...
For Blackfury, the `ClawbackVestingAccount` is used to allocate tokens to core team members and advisors to incentivize long-term participation in the project.
