...
func (suite *ScheduleTestSuite) TestScaleCoins() {
	testCases := []struct {
		...
		{
			"one coin",
			sdk.NewCoins(sdk.NewCoin("blackfury", sdk.NewInt(10))),
			sdk.NewDecWithPrec(50, 2),
			sdk.NewCoins(sdk.NewCoin("blackfury", sdk.NewInt(5))),
		},
		{
			"zero coin",
			sdk.NewCoins(sdk.NewCoin("blackfury", sdk.ZeroInt())),
			sdk.NewDecWithPrec(50, 2),
			sdk.NewCoins(sdk.NewCoin("blackfury", sdk.ZeroInt())),
		},
		{
			"two coins",
			sdk.NewCoins(
				sdk.NewCoin("blackfury", sdk.NewInt(10)),
				sdk.NewCoin("photon", sdk.NewInt(20)),
			),
			sdk.NewDecWithPrec(50, 2),
			sdk.NewCoins(
				sdk.NewCoin("blackfury", sdk.NewInt(5)),
