...
import (
	context "context"
	fmt "fmt"
	types "cosmossdk.io/x/auth/vesting/types"
...
func init() {
	proto.RegisterType((*MsgCreateClawbackVestingAccount)(nil), "blackfury.vesting.v1.MsgCreateClawbackVestingAccount")
	proto.RegisterType((*MsgCreateClawbackVestingAccountResponse)(nil), "blackfury.vesting.v1.MsgCreateClawbackVestingAccountResponse")
	proto.RegisterType((*MsgClawback)(nil), "blackfury.vesting.v1.MsgClawback")
	proto.RegisterType((*MsgClawbackResponse)(nil), "blackfury.vesting.v1.MsgClawbackResponse")
}

func init() { proto.RegisterFile("blackfury/vesting/v1/tx.proto", fileDescriptor_0e70a71da0ce69ab) }
...
func (c *msgClient) CreateClawbackVestingAccount(ctx context.Context, in *MsgCreateClawbackVestingAccount, opts ...grpc.CallOption) (*MsgCreateClawbackVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.vesting.v1.Msg/CreateClawbackVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Clawback(ctx context.Context, in *MsgClawback, opts ...grpc.CallOption) (*MsgClawbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.vesting.v1.Msg/Clawback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateClawbackVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.vesting.v1.Msg/CreateClawbackVestingAccount",
	}
...
func _Msg_Clawback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.vesting.v1.Msg/Clawback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
