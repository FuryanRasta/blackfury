...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "blackfury.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("blackfury/vesting/v1/vesting.proto", fileDescriptor_64bdc95247c207c8) }
