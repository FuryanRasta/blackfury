...
Say, there are several incentives that have registered an allocation for the $BLACKFURY coin and the allocation meter for $BLACKFURY is at 97%. Then a new incentve proposal can only include an $BLACKFURY allocation at up to 3%, claiming the last remaining allocation capcaity from the $BLACKFURY rewards in the inflation pool.
