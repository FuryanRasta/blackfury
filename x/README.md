...
Here are some production-grade modules that can be used in Blackfury applications, along with their respective documentation:
...
- [erc20](erc20/spec/README.md) - Trustless, on-chain bidirectional internal relaying (*aka* intrarelaying) of tokens between Blackfury' EVM and Cosmos runtimes.
